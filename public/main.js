...
/***/ "./src/app/_services/audio-recording.service.ts":
/*!******************************************************!*\
  !*** ./src/app/_services/audio-recording.service.ts ***!
  \******************************************************/
...
var AudioRecordingService = /** @class */ (function () {
    ...
    AudioRecordingService.prototype.startNewRecording = function () {
        var _this = this;
        if (this.recorder) {
            return;
        }
    ...
    AudioRecordingService.prototype.continueRecording = function () {
        if (this.recorder) {
            return;
        }
    ...
    AudioRecordingService.prototype.stopRecording = function () {
        ...
        if (this.recorder) {
            ...
            this.recorder.stop(function (blob) {
                if (_this.startTime) {
                    var mp3Name_1 = encodeURIComponent('audio_' + new Date().getTime() + '.mp3');
                    _this.buffer = _this.recorder.buffer;
                    //var prova = new Int16Array(this.buffer);
                    _this.stopMedia();
                    fetch(URL.createObjectURL(blob)).then(function (res) {
    ...
    AudioRecordingService.prototype.uploadAudio = function (blob, filename, date) {
        ...
        this.http.post(API_URL + '/fileupload/', formData).subscribe(function (result) {
            ...
            _this.examService.addNewRecording(_this.activeExam.id, fileId).subscribe(function (response) {
                ...
                _this.examService.setActive(_this.activeExam.id);
...
/***/ "./src/app/_services/data/data.service.ts":
/*!************************************************!*\
  !*** ./src/app/_services/data/data.service.ts ***!
  \************************************************/
...
var DataService = /** @class */ (function () {
    function DataService() {
        ...
        this.obs = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"]();
    }
    DataService.prototype.pendingChanges = function () {
        return this.unstagedChanges;
    };
    DataService.prototype.setChanges = function (b) {
...
/* harmony import */ var _data_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data/data.service */ "./src/app/_services/data/data.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DataService", function() { return _data_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]; });
...
/* harmony import */ var _edit_patient_edit_patient_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit-patient/edit-patient.component */ "./src/app/edit-patient/edit-patient.component.ts");
/* harmony import */ var _interview_interview_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./interview/interview.component */ "./src/app/interview/interview.component.ts");
/* harmony import */ var _exam_resume_exam_resume_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./exam-resume/exam-resume.component */ "./src/app/exam-resume/exam-resume.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'dashboard', component: _logged_user_wrapper_logged_user_wrapper_component__WEBPACK_IMPORTED_MODULE_2__["LoggedUserWrapperComponent"] },
    { path: 'editpatient', component: _edit_patient_edit_patient_component__WEBPACK_IMPORTED_MODULE_4__["EditPatientComponent"] },
    { path: 'interview', component: _interview_interview_component__WEBPACK_IMPORTED_MODULE_5__["InterviewComponent"] },
    { path: 'resume', component: _exam_resume_exam_resume_component__WEBPACK_IMPORTED_MODULE_6__["ExamResumeComponent"] },
...
/* harmony import */ var _services_audio_recording_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_services/audio-recording.service */ "./src/app/_services/audio-recording.service.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _register_form_register_form_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./register-form/register-form.component */ "./src/app/register-form/register-form.component.ts");
/* harmony import */ var _alert_message_alert_message_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./alert-message/alert-message.component */ "./src/app/alert-message/alert-message.component.ts");
/* harmony import */ var _logged_user_wrapper_logged_user_wrapper_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./logged-user-wrapper/logged-user-wrapper.component */ "./src/app/logged-user-wrapper/logged-user-wrapper.component.ts");
...
/* harmony import */ var _recording_recording_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./recording/recording.component */ "./src/app/recording/recording.component.ts");
/* harmony import */ var _exam_navbar_exam_navbar_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./exam-navbar/exam-navbar.component */ "./src/app/exam-navbar/exam-navbar.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _alert_message_alert_message_component__WEBPACK_IMPORTED_MODULE_12__["AlertMessageComponent"],
                _logged_user_wrapper_logged_user_wrapper_component__WEBPACK_IMPORTED_MODULE_13__["LoggedUserWrapperComponent"],
                ...
                _recording_recording_component__WEBPACK_IMPORTED_MODULE_23__["RecordingComponent"],
                _exam_navbar_exam_navbar_component__WEBPACK_IMPORTED_MODULE_24__["ExamNavbarComponent"]
            ],
            imports: [
            ...
            providers: [_services_audio_recording_service__WEBPACK_IMPORTED_MODULE_9__["AudioRecordingService"]],
...
var EditPatientComponent = /** @class */ (function () {
    function EditPatientComponent(route, patientService, examService, userService, dataService, formBuilder) {
        this.route = route;
    ...
    EditPatientComponent.prototype.ngOnInit = function () {
        ...
        this.patientForm = this.formBuilder.group({
            ...
            eta: [this.activePatient.eta, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
        ...
        Object.keys(this.patientForm.controls).forEach(function (key) {
            ...
            _this.patientForm.controls[key].valueChanges.subscribe(function (data) {
                _this.formChanged();
            });
        });
        this.formIsChanged = false;
    ...
    EditPatientComponent.prototype.formChanged = function () {
    ...
    EditPatientComponent.prototype.checkPatientData = function () {
    ...
    EditPatientComponent.prototype.save = function (e, p) {
        ...
        this.patientService.savePatient(p).subscribe(function (data) {
            ...
            _this.formIsChanged = false;
            _this.dataService.setChanges(false);
    ...
    EditPatientComponent.prototype.print = function () {
        console.log(this.patientForm, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"]);
    };
...
var ExamListViewComponent = /** @class */ (function () {
    ...
    */ /*
    ...
    ExamListViewComponent.prototype.openDeleteModal = function (id) {
        this.delete_exam = true;
        this.desiredDeleteId = id;
        this.loadExamInfo(id);
    };
    ExamListViewComponent.prototype.loadExamInfo = function (eid) {
        for (var _i = 0, _a = this.exams; _i < _a.length; _i++) {
            var e = _a[_i];
            if (e.id == eid) {
                this.patientName = e.patient.nome + " " + e.patient.cognome;
            }
        }
    };
...
/***/ "./src/app/exam-navbar/exam-navbar.component.html":
/*!********************************************************!*\
  !*** ./src/app/exam-navbar/exam-navbar.component.html ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./src/app/exam-navbar/exam-navbar.component.scss":
/*!********************************************************!*\
  !*** ./src/app/exam-navbar/exam-navbar.component.scss ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./src/app/exam-navbar/exam-navbar.component.ts":
/*!******************************************************!*\
  !*** ./src/app/exam-navbar/exam-navbar.component.ts ***!
  \******************************************************/
/*! exports provided: ExamNavbarComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExamNavbarComponent", function() { return ExamNavbarComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var ExamNavbarComponent = /** @class */ (function () {
    ...
    ExamNavbarComponent.prototype.getActualUrl = function () {
        var _url = window.location.href.split('/');
        return '/' + _url[_url.length - 1];
    };
    ExamNavbarComponent.prototype.navigateTo = function (url) {
        this.router.navigate([url]);
    };
    ExamNavbarComponent.prototype.ignoreEdit = function () {
        this.dataService.setChanges(false);
    ...
    ExamNavbarComponent.prototype.saveExit = function () {
        if (this.getActualUrl() == '/editpatient')
            this.saveInterview();
        else if (this.getActualUrl() == '/interview')
            this.savePatient();
        this.exit();
    };
    ExamNavbarComponent.prototype.saveMove = function () {
        if (this.getActualUrl() == '/editpatient')
            this.saveInterview();
        else if (this.getActualUrl() == '/interview')
            this.savePatient();
    ...
    ExamNavbarComponent.prototype.openSwitchModal = function () {
        this.unstagedChanges = this.dataService.pendingChanges();
        this.switchModal = true;
    };
    ExamNavbarComponent.prototype.closeSwitchModal = function () {
    ...
    ExamNavbarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./exam-navbar.component.html */ "./src/app/exam-navbar/exam-navbar.component.html"),
            styles: [__webpack_require__(/*! ./exam-navbar.component.scss */ "./src/app/exam-navbar/exam-navbar.component.scss")]
        }),
...
var InterviewItemComponent = /** @class */ (function () {
    ...
    InterviewItemComponent.prototype.reset = function () {
        this.frequenza = 0;
        this.progress = 0;
        this.clear();
        this.save();
...
/***/ "./src/app/pdf-resume/pdf-resume.component.ts":
/*!****************************************************!*\
  !*** ./src/app/pdf-resume/pdf-resume.component.ts ***!
  \****************************************************/
/*! exports provided: PdfResumeComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var PdfResumeComponent = /** @class */ (function () {
    ...
    PdfResumeComponent.prototype.openModal = function () {
        this.pdf_modal = true;
        this.totalscore = this.examService.getActiveExam().score;
    };
...
/***/ "./src/app/recording/recording.component.html":
/*!****************************************************!*\
  !*** ./src/app/recording/recording.component.html ***!
  \****************************************************/
/*! no static exports found */
...
var RecordingComponent = /** @class */ (function () {
    ...
    RecordingComponent.prototype.resumeRecording = function () {
        if (this.isRecording) {
            this.isPaused = false;
            this.audioRecordingService.resumeRecording();
        }
    };
    RecordingComponent.prototype.continueRecording = function () {
        if (!this.isRecording) {
            this.isRecording = true;
            this.audioRecordingService.continueRecording();
        }
    };
    RecordingComponent.prototype.pauseRecording = function () {
        if (this.isRecording) {
            this.isPaused = true;
            this.audioRecordingService.pauseRecording();
        }
    };
    RecordingComponent.prototype.abortRecording = function () {
        if (this.isRecording) {
            this.isRecording = false;
            this.audioRecordingService.abortRecording();
        }
    };
    RecordingComponent.prototype.stopRecording = function () {
        if (this.isRecording) {
        ...
        if (activeExam.recordings != undefined) {
            ...
            this.audioRecordingService.deleteAudio(recordingId).subscribe(function (data) {
                ...
                _this.examService.saveExam(activeExam).subscribe(function (success) {
                    _this.examService.setActive(activeExam.id);
                    _this.blobUrl = null;
